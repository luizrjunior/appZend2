 ...
 */
class UsuarioEntity extends \Rifas\Entity\UsuarioEntity implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Rifas\\Entity\\UsuarioEntity' . "\0" . 'idUsuario', '' . "\0" . 'Rifas\\Entity\\UsuarioEntity' . "\0" . 'login', '' . "\0" . 'Rifas\\Entity\\UsuarioEntity' . "\0" . 'senha', '' . "\0" . 'Rifas\\Entity\\UsuarioEntity' . "\0" . 'email');
        }
